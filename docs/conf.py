...
_gitlab_org = "cblegareprof"
_gitlab_subgroups = []
_gitlab_project = "201-SN4-RE"
...
_title = _gitlab_project

project = os.getenv("SPHINX_CONF_PROJECT", _gitlab_project)
author = os.getenv("SPHINX_CONF_AUTHOR", "Charles Bouchard-Légaré")
copyright = f"{_today.year}, {author}"

# The full version, including alpha/beta/rc tags
release = os.getenv("SPHINX_CONF_RELEASE", _today.strftime("YYYY-MM-DD"))
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitLab",
            "url": f"https://gitlab.com/{_gitlab_path}",
            "icon": "fab fa-gitlab",
        },
    ],
    "show_prev_next": True,
...
html_context = {
    ...
    "gitlab_user": _gitlab_org,
    "gitlab_repo": _gitlab_project,
    "gitlab_version": "main",
    "doc_path": "docs",
...
nitpick_ignore = [
    ...
    ("py:class", "docutils.nodes.reference"),
...
extlinks = {
    ...
    "release": (
        f"https://gitlab.com/{_gitlab_path}/-/releases/%s",
        "Sphinx-Compendia v%s",
    ),
    "mr": (
        f"https://gitlab.com/{_gitlab_path}/-/merge_requests/%s",
        "!%s",
    ),
    "issue": (
        f"https://gitlab.com/{_gitlab_path}/-/issues/%s",
        "#%s",
    ),
